...
namespace ConfigGen.Api.Tests.FilteringTests
{
    internal class when_invoked_with_LocalOnly_preference_and_with_a_matching_configuration_in_the_settings_file : GenerationServiceTestBase
    {
        Establish context = () =>
        {
    ...
    internal class when_invoked_with_LocalOnly_preference_and_without_a_matching_configuration_in_the_settings_file_but_with_a_default : GenerationServiceTestBase
    {
        Establish context = () =>
        {
  ...
  <Value2>Default-Value2</Value2>
    ...
    internal class when_invoked_with_LocalOnly_preference_and_without_a_matching_configuration_in_the_settings_file_and_with_no_default : GenerationServiceTestBase
    {
        Establish context = () =>
        {
            Assembly.GetExecutingAssembly().CopyEmbeddedResourceFileTo("TestResources.SimpleSettings.FiveConfigurations.TwoValues.xls", "App.Config.Settings.xls");
    ...
    internal class when_invoked_with_GenerateSpecifiedOnly_preference_that_matches_no_machines : GenerationServiceTestBase
    {
        Establish context = () =>
        {
            Assembly.GetExecutingAssembly().CopyEmbeddedResourceFileTo("TestResources.SimpleSettings.FiveConfigurations.TwoValues.xls", "App.Config.Settings.xls");
    ...
    internal class when_invoked_with_GenerateSpecifiedOnly_preference_that_matches_two_machines : GenerationServiceTestBase
    {
        Establish context = () =>
        {
            Assembly.GetExecutingAssembly().CopyEmbeddedResourceFileTo("TestResources.SimpleSettings.FiveConfigurations.TwoValues.xls", "App.Config.Settings.xls");
    ...
    internal class when_invoked_with_FilterMachinesRegexp_preference_that_matches_no_machines : GenerationServiceTestBase
    {
        Establish context = () =>
        {
            Assembly.GetExecutingAssembly().CopyEmbeddedResourceFileTo("TestResources.SimpleSettings.FiveConfigurations.TwoValues.xls", "App.Config.Settings.xls");
    ...
    internal class when_invoked_with_FilterMachinesRegexp_preference_that_matches_two_machines : GenerationServiceTestBase
    {
        Establish context = () =>
        {
            Assembly.GetExecutingAssembly().CopyEmbeddedResourceFileTo("TestResources.SimpleSettings.FiveConfigurations.TwoValues.xls", "App.Config.Settings.xls");
    ...
    internal class when_invoked_with_both_GenerateSpecifiedOnly_and_FilterMachinesRegexp_preferences : GenerationServiceTestBase
    {
        Establish context = () =>
        {
            Assembly.GetExecutingAssembly().CopyEmbeddedResourceFileTo("TestResources.SimpleSettings.FiveConfigurations.TwoValues.xls", "App.Config.Settings.xls");
