...
DEV                 | App1.Config");
        ...
        [Then]
        public void the_generated_configuration_reported_the_unknown_token_from_the_template_as_an_unrecognised_token()
            => Result.Configuration(1).HadUnrecognisedToken("NonExistentField");
