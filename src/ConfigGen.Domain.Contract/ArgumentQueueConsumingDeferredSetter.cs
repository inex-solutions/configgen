...
{
    public class ArgumentQueueConsumingDeferredSetter<TTargetType, TSetterType> : IDeferedSetter<TTargetType>
    {
        [NotNull]
        ...
        public ArgumentQueueConsumingDeferredSetter([NotNull] Func<Queue<string>, Result<TSetterType>> parse, [NotNull] Action<TTargetType, TSetterType> set)
        {
        ...
        public virtual Result<object> Parse(Queue<string> argsQueue)
        {
