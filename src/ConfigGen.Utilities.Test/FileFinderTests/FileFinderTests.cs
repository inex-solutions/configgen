...
namespace ConfigGen.Utilities.Test.FileFinderTests
{
    ...
    {
        protected override void When() => FileFinder.FindFile(TestDirectory.FullName, true, file => FoundFiles.Add(file.Name));
    ...
    {
        protected override void When() => FileFinder.FindFile("*", TestDirectory.FullName, false, file => FoundFiles.Add(file.Name));
    ...
    {
        protected override void When() => FileFinder.FindFile("*.txt", TestDirectory.FullName, true, file => FoundFiles.Add(file.Name));
    ...
    {
        protected override void When() => FileFinder.FindFile("*.txt", TestDirectory.FullName, false, file => FoundFiles.Add(file.Name));
