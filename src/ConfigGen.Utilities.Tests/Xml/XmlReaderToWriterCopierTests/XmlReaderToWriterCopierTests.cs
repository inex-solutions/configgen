...
{
    public abstract class XmlReaderToWriterCopierTests : NUnitSpecification
    {
        protected string Xml;
        protected string Result;

        protected void RunCopyTest(string input, Func<XmlNodeType, XmlReader, XmlWriter, bool> onCopyCallback)
        {
    ...
    public class when_copying_xml_with_a_single_child_element : XmlReaderToWriterCopierTests
    {
        ...
        [Then] public void the_input_and_output_are_identical() => Result.ShouldBe(Xml);
    }
    ...
    {
        public override void Given() => Xml = @"<root attribute1=""value1"" attribute2=""value2""><child /></root>";
        public override void When() => RunCopyTest(input: Xml, onCopyCallback: (nodeType, reader, writer) => nodeType != XmlNodeType.Attribute);
        [Then] public void the_attributes_are_not_written_to_the_output() => Result.ShouldBe("<root><child /></root>");
    }
