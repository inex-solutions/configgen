...
{
    public class ConsoleOutputEventLoggerDecorator : IEventLogger
    {
        private readonly IEventLogger _innerLogger;

        public ConsoleOutputEventLoggerDecorator(IEventLogger innerLogger)
        {
